...
COMMENT ON COLUMN companies.priority IS 'Priority level: 1=High, 2=Medium, 3=Low';
...
COMMENT ON COLUMN contacts.priority IS 'Priority level: 1=High, 2=Medium, 3=Low';
COMMENT ON COLUMN activities.priority IS 'Priority level: 1=High, 2=Medium, 3=Low';
